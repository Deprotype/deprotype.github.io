...
import { generate_trees } from "../../N-of-1-Experimentation/modules/graphs_n_trees/Tree.js";
...
let experiment_configuration_function = (writer) => {
    return {
        ...
        introduction_pages: writer.stage_string_pages_commands([
            writer.convert_string_to_html_string("Please, just do this experiment only, when you have enough time (about 15 minutes), are concentrated enough, and motivated enough.\n\nPlease, open the browser in fullscreen mode (probably by pressing [F11]). You should have a screen with a resolution of 1920x1080 or more."),
        ...
        pre_run_experiment_instructions: writer.string_page_command(writer.convert_string_to_html_string("You entered the experiment phase. Now, it should take probably 8-12 minutes until the end of the experiment.")),
        post_questionnaire: [
