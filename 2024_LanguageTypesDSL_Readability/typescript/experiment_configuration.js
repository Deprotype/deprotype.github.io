...
import { alternatives, keys, random_array_element, Reaction_Time, SET_SEED } from "../../N-of-1-Experimentation/modules/Experimentation/Experimentation.js";
import { create_tasks_grouped_by_error_position } from "./code/Feature.js";
let SEED = "42";
SET_SEED(SEED);
...
let experiment_configuration_function = (writer) => {
    return {
        ...
        task_configuration: (t) => {
            let task = random_array_element(tasks["" + t.treatment_value("Error_position")]);
