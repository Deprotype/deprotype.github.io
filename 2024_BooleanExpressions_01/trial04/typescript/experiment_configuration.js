...
let experiment_configuration_function = (writer) => {
    return {
        ...
        task_configuration: (t) => {
            let string_to_show;
            string_to_show = generate_boolean_expression_as_string(t.treatment_value("Format"), parseInt(t.treatment_value("TermsPerAnd")), parseInt(t.treatment_value("AnswerPosition")));
