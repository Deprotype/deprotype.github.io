...
let SEED = "42";
SET_SEED(SEED);
function generated_version_1(guard_executed) {
    let ws2 = "&nbsp;".repeat(2);
    let ws4 = "&nbsp;".repeat(4);
    let ret = "";
    if (guard_executed) {
...
function generated_version_2(guard_executed) {
...
let experiment_configuration_function = (writer) => {
    return {
        ...
        task_configuration: (t) => {
            ...
            // )/
            let string_to_show = "";
            let guard_executed = t.treatment_value("Answer") == "1";
            ...
            t.do_print_task = () => {
                writer.clear_stage();
                writer.print_html_on_stage("<div class='sourcecode'>" + string_to_show + "<div>");
            };
